      ...
      <div className="hero__band">
        <div className="hero__photos">
          <div className="hero__photo">
            <Image src="/images/hero-left.png" alt="The arched colonnade at Kofi &amp; Kompany" fill priority sizes="50vw" />
          </div>
          <div className="hero__photo">
            <Image src="/images/hero-right.png" alt="Ian kissing Jane’s hand" fill priority sizes="50vw" />
          </div>
        </div>
